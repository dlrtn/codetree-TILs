...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < k; i++) {
            ...
            System.out.print(a_cnt[x2][y2] - a_cnt[x1][y2] - a_cnt[x2][y1] + a_cnt[x1][y1] + " ");
            System.out.print(b_cnt[x2][y2] - b_cnt[x1][y2] - b_cnt[x2][y1] + b_cnt[x1][y1] + " ");
            System.out.println(c_cnt[x2][y2] - c_cnt[x1][y2] - c_cnt[x2][y1] + c_cnt[x1][y1]);
        }
